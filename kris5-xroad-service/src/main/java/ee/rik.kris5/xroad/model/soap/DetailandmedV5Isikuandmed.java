 ...
 *       &lt;sequence&gt;
 *         &lt;element name="kaardile_kantud_isikud" type="{http://producers.arireg.xtee.riik.ee/producer/arireg}detailandmed_v5_kaardile_kantud_isikud"/&gt;
 *         &lt;element name="esindusoiguse_normaalregulatsioonid" type="{http://producers.arireg.xtee.riik.ee/producer/arireg}detailandmed_v5_esindusoiguse_normaalregulatsioonid" minOccurs="0"/&gt;
 *         &lt;element name="esindusoiguse_eritingimused" type="{http://producers.arireg.xtee.riik.ee/producer/arireg}detailandmed_v5_esindusoiguse_eritingimused" minOccurs="0"/&gt;
 *         &lt;element name="osapandid_tingimuslikud_voorandamised" type="{http://producers.arireg.xtee.riik.ee/producer/arireg}detailandmed_v5_osa_pandid" minOccurs="0"/&gt;
 *         &lt;element name="kaardivalised_isikud" type="{http://producers.arireg.xtee.riik.ee/producer/arireg}detailandmed_v5_kaardivalised_isikud"/&gt;
 *         &lt;element name="hooneyhistu_liikmed" type="{http://producers.arireg.xtee.riik.ee/producer/arireg}detailandmed_v5_hooneyhistu_liikmed"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
