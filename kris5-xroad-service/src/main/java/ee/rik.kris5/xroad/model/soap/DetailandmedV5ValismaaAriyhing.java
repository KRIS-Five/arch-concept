 ...
 *       &lt;sequence&gt;
 *         &lt;element name="arinimi" type="{http://producers.arireg.xtee.riik.ee/producer/arireg}detailandmed_v5_va_arinimed"/&gt;
 *         &lt;element name="asukoht" type="{http://producers.arireg.xtee.riik.ee/producer/arireg}detailandmed_v5_va_asukohad"/&gt;
 *         &lt;element name="sarnane_eesti_oiguslik_vorm" type="{http://producers.arireg.xtee.riik.ee/producer/arireg}detailandmed_v5_va_sisud"/&gt;
 *         &lt;element name="sarnane_eesti_oiguslik_vorm_markus" type="{http://producers.arireg.xtee.riik.ee/producer/arireg}detailandmed_v5_va_sisud"/&gt;
 *         &lt;element name="maa_mille_seaduse_alusel_tegutseb" type="{http://producers.arireg.xtee.riik.ee/producer/arireg}detailandmed_v5_va_sisud"/&gt;
 *         &lt;element name="maa_mille_seaduse_alusel_tegutseb_markus" type="{http://producers.arireg.xtee.riik.ee/producer/arireg}detailandmed_v5_va_sisud"/&gt;
 *         &lt;element name="register" type="{http://producers.arireg.xtee.riik.ee/producer/arireg}detailandmed_v5_va_sisud"/&gt;
 *         &lt;element name="registreerimisnumber" type="{http://producers.arireg.xtee.riik.ee/producer/arireg}detailandmed_v5_va_sisud"/&gt;
 *         &lt;element name="majandusaasta_aruande_avalikustamise_kohustus" type="{http://producers.arireg.xtee.riik.ee/producer/arireg}detailandmed_v5_va_sisud"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
