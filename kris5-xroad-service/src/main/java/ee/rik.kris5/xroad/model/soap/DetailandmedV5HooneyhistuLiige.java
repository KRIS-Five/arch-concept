 ...
 *         &lt;element name="liikmed" type="{http://producers.arireg.xtee.riik.ee/producer/arireg}detailandmed_v5_hy_liikmed" minOccurs="0"/&gt;
 *         &lt;element name="kitsendused" type="{http://producers.arireg.xtee.riik.ee/producer/arireg}detailandmed_v5_hy_kitsendused" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class DetailandmedV5HooneyhistuLiige {
    ...
    @XmlElementRef(name = "pindala", type = JAXBElement.class, required = false)
