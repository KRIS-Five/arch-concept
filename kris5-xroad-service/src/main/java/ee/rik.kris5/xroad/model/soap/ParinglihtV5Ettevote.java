 ...
 *         &lt;element name="kehtetud_nimed" type="{http://producers.arireg.xtee.riik.ee/producer/arireg}paringliht_v5_kehtetudnimed" minOccurs="0"/&gt;
 ...
 *         &lt;element name="evkapitalid" type="{http://producers.arireg.xtee.riik.ee/producer/arireg}paringliht_v5_evkapital" minOccurs="0"/&gt;
 *         &lt;element name="evaadressid" type="{http://producers.arireg.xtee.riik.ee/producer/arireg}paringliht_v5_evaadress" minOccurs="0"/&gt;
...
public class ParinglihtV5Ettevote {
    ...
    @XmlElementRef(name = "evkapitalid", type = JAXBElement.class, required = false)
    protected JAXBElement<ParinglihtV5Evkapital> evkapitalid;
    @XmlElementRef(name = "evaadressid", type = JAXBElement.class, required = false)
