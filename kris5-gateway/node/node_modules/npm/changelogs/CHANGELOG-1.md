...
* Add back `npm prune --shared`, which was removed in 1.3.24.
...
* Fix `npm install` overwriting `npm link`-ed dependencies when they are tagged
  ...
  [@evanlucas](https://github.com/evanlucas))
* Remove `npm prune --shared` since it buggily removed some dependencies
  that were necessary for shared; see
