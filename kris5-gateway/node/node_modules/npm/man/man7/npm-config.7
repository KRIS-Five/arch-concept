...
.P
When "prod" or "shared" and running local \fBnpm install\fP without any
arguments, only non\-devDependencies (and their dependencies) are
installed\.
.P
When "prod" or "shared" and running local \fBnpm ls\fP, \fBnpm outdated\fP, or
\fBnpm update\fP, is an alias for \fB\-\-shared\fP\|\.
.SS optional
.RS 0
.IP \(bu 2
Default: true
